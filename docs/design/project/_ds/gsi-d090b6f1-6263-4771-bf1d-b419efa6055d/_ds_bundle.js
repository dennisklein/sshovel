/* @ds-bundle: {"format":3,"namespace":"GSISlidedeck_d090b6","components":[{"name":"Logo","sourcePath":"components/brand/Logo.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Stat","sourcePath":"components/core/Stat.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"}],"sourceHashes":{"components/brand/Logo.jsx":"7b865ff6d9bc","components/core/Button.jsx":"e94644100a6c","components/core/Card.jsx":"259732fe0363","components/core/Stat.jsx":"e88fce88b88a","components/core/Tag.jsx":"161f59d2884f","deck-stage.js":"208980974db4"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.GSISlidedeck_d090b6 = window.GSISlidedeck_d090b6 || {});
...
// Official GSI wordmark, from the corporate SVG (viewBox 314×115). The four
// black paths are the letters G S I (the "I" is a stem); the orange circle is
// the dot and the orange rect is the stem's stripe. Inline SVG keeps it crisp at
// any size and lets `variant` recolour the letters without a second asset.
const ORANGE = '#FABE5D';
const PATHS = ['M17.8,55.9c0-1.4,0.7-2.2,3.2-2.2h79.9c0.7,0.1,1.8,0.7,2,1.5c0,4.1,0,8.2,0.1,12.3H72.6h-1.4c0-2.3,0.7-7-1.6-7H50.1c-0.7,0.3-1.4,0.9-1.7,1.6c0,10.9,0,22.9,0,32.8c0.8,1.9,2.8,1.4,4.6,1.5h16.1c0.6-0.1,1.3-0.7,1.4-1.4l-0.1-11.7c-0.8-3-4-1.7-6.5-2H60v-5.9h43v24.3c-0.4,1-1,2.1-2,2.7l-1.9,0.5H19.4c-0.9-0.1-1.3-1.2-1.5-2l-0.1-0.9L17.8,55.9z', 'M127.6,89.1h32.5c0,2.7-0.6,6.9,1.6,6.9c6.1,0.1,12.5,0,18.5,0l1.6-1.9V83.3c0-0.7-0.2-1.6-1.7-1.6h-50.2c-1.8,0-2.3-2.1-2.3-3.7V56.4c0-2.7,3.8-2.5,6.1-2.5h77.6c0.9,0.3,2.1,0.4,2.2,1.6v11.4H182c0-2.1,0.6-6.3-1.3-6.3c-6.5,0-13.5,0-20.2,0l-0.8,0.8v13.1c0,2.2,3.7,1.6,7,1.6h43.8c2.1,0,2.9,0.3,2.9,1.7c0,7.6,0,15.2,0,22c0,1.3-0.4,2.9-1.9,3.2h-6.2h-75c-1.3-0.2-2.9-1.3-2.9-3.1C127.5,96.4,127.6,93.2,127.6,89.1z', 'M233.6,96c3.6-0.2,8.5,0.9,10.2-2.2l0.2-1.9V64.5c-0.9-3.6-6.6-2.9-10.3-2.9v-7.7h31.8v49.6h-31.9C233.6,101,233.6,98.5,233.6,96z', 'M302.5,96c-3.6-0.2-8.5,0.9-10.2-2.2l-0.2-1.9V64.5c0.9-3.6,6.6-2.9,10.3-2.9v-7.7h-31.8v49.6h31.9C302.5,101,302.5,98.5,302.5,96z'];

/**
 * GSI logo lockup (official vector). `positive` (black letters) on light
 * backgrounds, `reversed` (white letters) on navy / dark / photographic ones.
 * The orange dot + stripe stay orange in both.
 */
function Logo({
  variant = 'positive',
  height = 40,
  alt = 'GSI — Helmholtzzentrum für Schwerionenforschung',
  style = {},
  ...rest
}) {
  const letter = variant === 'reversed' ? '#FFFFFF' : '#1A1A1A';
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * GSI Button — the primary action element.
 * Orange = primary action, outline = secondary, ghost = low-emphasis,
 * dark = for use on light surfaces where a heavier weight is needed.
 */
function Button({
  variant = 'primary',
  size = 'md',
  ...
  const palette = {
    primary: {
      ...
      fg: 'var(--gsi-ink)',
      border: 'transparent',
      bgHover: 'var(--gsi-orange-strong)'
    },
    secondary: {
      bg: 'transparent',
      fg: 'var(--gsi-ink)',
      border: 'var(--gsi-grey-300)',
      bgHover: 'var(--gsi-grey-50)'
    },
    ghost: {
      bg: 'transparent',
      fg: 'var(--gsi-ink)',
      border: 'transparent',
      bgHover: 'var(--gsi-grey-100)'
    },
    dark: {
      bg: 'var(--gsi-navy)',
      fg: 'var(--gsi-white)',
      border: 'transparent',
      bgHover: 'var(--gsi-navy-700)'
    }
  };
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * GSI Card — a surface container. Sharp corners, 1px border, optional orange
 * top or left accent. Hover lift is opt-in (for clickable cards).
 */
function Card({
  children,
  accent = 'none',
  ...
  const base = {
    position: 'relative',
    background: dark ? 'var(--gsi-navy)' : 'var(--color-surface)',
    ...
    boxSizing: 'border-box',
    ...(accent === 'top' ? {
      borderTop: '3px solid var(--gsi-orange)'
    } : {}),
    ...(accent === 'left' ? {
      borderLeft: '3px solid var(--gsi-orange)'
    } : {}),
    ...style
  };
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * GSI Stat — a single key figure, set in Helvetica (Bold) with an orange accent.
 * Used on slides and dashboards for facility numbers and results.
 */
function Stat({
  value,
  label,
  ...
  const wrap = {
    ...
    textAlign: align,
    paddingLeft: accent ? '16px' : 0,
    borderLeft: accent ? '3px solid var(--gsi-orange)' : 'none',
    ...style
  };
  const num = {
    ...
    /* Overridable on dark surfaces: set --stat-value / --stat-label on a parent. */
    color: 'var(--stat-value, var(--text-primary))'
  };
  const u = {
    fontFamily: 'var(--font-display)',
    fontSize: '22px',
    fontWeight: 700,
    color: 'var(--stat-unit, var(--text-accent))',
    marginLeft: '4px'
  };
  const lab = {
    fontFamily: 'var(--font-sans)',
    fontSize: '14px',
    fontWeight: 500,
    color: 'var(--stat-label, var(--text-secondary))',
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * GSI Tag — compact label for categories, statuses and metadata.
 * `soft` (tinted) by default; `solid` for high emphasis; `outline` for quiet.
 */
function Tag({
  children,
  tone = 'neutral',
  ...
  const tones = {
    neutral: {
      base: 'var(--gsi-grey-700)',
      soft: 'var(--gsi-grey-100)',
      solid: 'var(--gsi-grey-700)',
      solidFg: 'var(--gsi-white)'
    },
    accent: {
      base: 'var(--ui-orange)',
      soft: 'var(--gsi-orange-soft)',
      solid: 'var(--gsi-orange)',
      solidFg: 'var(--gsi-ink)'
    },
    info: {
      base: 'var(--ui-blue)',
